	...
	<main class="full-box main-container">
			...
			<div class="full-box nav-lateral-content">
				...
				<nav class="full-box nav-lateral-menu">
					<ul>
						...
						<li>
							<a href="mostrar.php"><i class="fas fa-users fa-fw"></i> &nbsp; Autores</a>
						</li>
						<li>
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fab fa-dashcube fa-fw"></i> &nbsp; AUTORES
				</h3>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						...
						<a href="mostrar.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE AUTORES</a>
					</li>
					<li>
						<a class="active" href="#"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR AUTORES</a>
					</li>
			...
			<div class="col-12 col-md-6">
				<div class="form-group">
					...
					<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="nomau"  maxlength="50">
				</div>
			</div>
			<div class="col-12 col-md-6">
				<div class="form-group">
					<label for="cliente_nombre" class="bmd-label-floating">Apellido</label>
					<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="apeau"  maxlength="50">
				</div>
			</div>
			<div class="col-12 col-md-4">
					<div class="form-group">
						<label for="cliente_apellido" class="bmd-label-floating">Alias</label>
						<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="alias"  maxlength="40">
					</div>
			</div>

			<div class="col-12 col-md-4">
					<div class="form-group">
						<label for="cliente_apellido" class="bmd-label-floating">Correo</label>
			...
			<div class="col-12 col-md-4">
					<div class="form-group">
						...
						<input type="date" class="form-control" name="fecna">
					</div>
			</div>

			<div class="col-12 col-md-4">
					<div class="form-group">
						<label for="cliente_apellido" class="bmd-label-floating">Bibliografia</label>
					
						<textarea name="biblio"  class="form-control" rows="10" cols="50"></textarea>
					</div>
			</div>
