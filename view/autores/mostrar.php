			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						...
						<a class="active" href="#"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE AUTORES</a>
					</li>
					<li>
						<a href="nuevo.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR AUTORES</a>
					</li>
...
<?php if(count($data)>0):?>
	...
	<table class="table table-dark table-sm">
		...
		<tr class="text-center">
			<td><?php echo $d->id_au; ?></td>
			<td><?php echo $d->nomau; ?>&nbsp;<?php echo $d->apeau; ?></td>
		...
		<form  method="get" action="javascript:activo('<?php echo $d->id_au; ?>')">
		<strong>	<button type="submit" class="badge badge-success">Activo</strong></button>
		</form>
			<?php  }   else {?> 

			 <form  method="get" action="javascript:inactivo('<?php echo $d->id_au; ?>')"> 
				<strong><button type="submit" class="badge badge-danger">Inactivo</strong></button>
			</form>
		<?php  } ?>                         
			</td>
			<td>
		<a href="#edit_<?php echo $d->id_au; ?>" title="Editar datos" data-backdrop="false" class="btn btn-primary btn-sm" data-toggle="modal"><span class="fas fa-edit" aria-hidden="true"></span></a>
		<a href="#delete_<?php echo $d->id_au; ?>" title="Eliminar" data-backdrop="false" class="btn btn-danger btn-sm" data-toggle="modal"><span class="fas fa-trash"></span></a>
	...
	<script src="../../assets/js/reloj.js"></script>
		<script>
	function activo(id_au)
{
	var id=id_au;
	$.ajax({
        type:"GET",
		url:"../../assets/ajax/editar_estado_activo_autores.php?id="+id,
    }).done(function(data){
...
function inactivo(id_au)
{
	var id=id_au;
	$.ajax({
		type:"GET",
		url:"../../assets/ajax/editar_estado_inactivo_autores.php?id="+id,
    }).done(function(data){
        window.location.href ='mostrar.php';
    })
}
