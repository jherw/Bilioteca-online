		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						...
						<a href="mostrar.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE LIBROS</a>
					</li>
					<li>
						<a class="active" href="#"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR LIBROS</a>
					</li>
             			...
             			<!-- Content here-->
			<div class="container-fluid">
				<form action="registro.php" enctype="multipart/form-data"  role="form" method="post" class="form-neon" autocomplete="off">
					<fieldset>
			...
			<div class="col-12 col-md-6">
				<div class="form-group">
					...
					<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="nomli"  maxlength="50">
				</div>
			</div>
			...
			<div class="col-12 col-md-6">
					<div class="form-group">
						<label for="item_estado" class="bmd-label-floating">Autor</label>
						<select class="form-control" name="id_au" id="autor">
				...
				<div class="col-12 col-md-6">
					<div class="form-group">
						<label for="item_estado" class="bmd-label-floating">Editorial</label>
						<select class="form-control" name="id_edi" id="editorial">
							<option value="" selected="" disabled="">Seleccione una opción</option>
				...
				<div class="col-12 col-md-6">
					<div class="form-group">
						...
						<select class="form-control" name="id_cate" id="categoria">
							<option value="" selected="" disabled="">Seleccione una opción</option>
				...
				<div class="col-12 col-md-6">
					<div class="form-group">
						<label for="item_estado" class="bmd-label-floating">Lugar</label>
			...
			<div class="col-12 col-md-4">
				<div class="form-group">
					<label for="prestamo_fecha_final">Fecha de edición</label>
					<input type="date" class="form-control" name="anedi">
				</div>
			</div>
			<div class="col-12 col-md-4">
					<div class="form-group">
						<label for="item_estado" class="bmd-label-floating">Idioma</label>
...
<div class="col-12 col-md-4">
				<div class="form-group">
					<label for="prestamo_fecha_final">Link</label>
					<input type="file" class="form-control" name="link">
				</div>
</div>
				<div class="col-12 col-md-4">
				<div class="form-group">
					<label for="cliente_nombre" class="bmd-label-floating">Páginas</label>
					<input type="text"  class="form-control" name="numpa">
				</div>
			</div>
			
			<div class="col-xs-12 col-sm-6">
				<label for="prestamo_fecha_final">Foto</label>
	...
	<div class="col-12 col-md-6">
					<div class="form-group">
						<label for="cliente_apellido" class="bmd-label-floating">Sinópsis</label>
					
						<textarea name="sinop"  class="form-control" rows="10" cols="50"></textarea>
					</div>
			</div>
  ...
  <script src="../../assets/js/funciones/editorial.js"></script>
