		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						...
						<a href="mostrar.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE CATEGORIAS</a>
					</li>
					<li>
						<a class="active" href="#"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR CATEGORIAS</a>
					</li>
			...
			<div class="col-12 col-md-6">
				<div class="form-group">
					...
					<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="nomcate"  maxlength="40">
				</div>
			</div>

			<div class="col-12 col-md-6">
				<div class="form-group">
					<label for="Foto" class="bmd-label-floating">Foto</label>
